    ...
    <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
        <div class="modal">
            ...
            <div class="modal-buttons">
                ...
                <button @click="deleteSelectedUser" :disabled="!selectedUser">Удалить</button>
            </div>
        </div>
    </div>
</template>
...
const getUsers = async () => {
    try {
        const response = await axios.get(`${apiBase}/api/getTeachers`)
...
const deleteSelectedUser = async () => {
    ...
    try {
        await axios.post(`${apiBase}/api/deleteTeacher`, {
